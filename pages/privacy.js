const Privacy = () => {
  return (
    <div>
      Empircal SEO Privacy Policy

This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from https://empirical-seo.noconsulate.now.sh/ (the “Site”).
...
CONTACT US
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at noconsulate@gmail.com or by mail using the details provided below:

  123 Fake Street, NEVADA, NV, 42069, United States
    </div>
  )
}
